...
function upload(e) {
    ...
    uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED, // or 'state_changed'
        function (snapshot) {
            ...
            let divLocation = document.getElementById("post"); // sua id hien anh
             // sua id hien anh
...
function upload1(e) {
    ...
    uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED, // or 'state_changed'
        function (snapshot) {
            ...
            let divLocation = document.getElementById("newA"); // sua id hien anh
...
function upload3(e) {
    ...
    uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED, // or 'state_changed'
        function (snapshot) {
            ...
            let divLocation = document.getElementById("changeImage"); // sua id hien anh
